 ...
 * 1) Создаём новый массив у которого длина равна сумме элементов двух массивов
 * 2) Делаем счетчик для первого и второго массива
 * 3) Начинаем проходиться по пустому результирующему массиву и
